 ...
 * @author USUARIO
 */
public class AddZelle extends javax.swing.JFrame {

    /**
     * Creates new form AddZelle
     */
    public AddZelle() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DOLARES EN ZELLE RECAUDADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddZelle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
