 ...
 * @author Azuaje
 */
public class Fact_FormasPago extends javax.swing.JFrame {

    /**
     * Creates new form FormasPagoFactura
     */
    public Fact_FormasPago() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CANCELAR FACTURA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fact_FormasPago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fact_FormasPago().setVisible(true);
            }
        });
    }
