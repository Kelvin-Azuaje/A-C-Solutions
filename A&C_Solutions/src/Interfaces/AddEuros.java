 ...
 * @author Azuaje
 */
public class AddEuros extends javax.swing.JFrame {

    /**
     * Creates new form AddEuros
     */
    public AddEuros() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EUROS RECAUDADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEuros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
