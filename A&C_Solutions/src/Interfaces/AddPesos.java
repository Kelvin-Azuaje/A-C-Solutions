 ...
 * @author Azuaje
 */
public class AddPesos extends javax.swing.JFrame {

    /**
     * Creates new form AddPesos
     */
    public AddPesos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PESOS RECAUDADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPesos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
